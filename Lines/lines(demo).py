#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""One Example of how to use PyGame."""
#
...
if __name__ == '__main__':
    try:
        ...
        main(settings[0], settings[3], settings[1], settings[2])
    except IOError: # demo
        print 'no settings found. starting demo...'
        groups = [{'numpoints'    : 4,
                   'numlines'     : 3,
                   'minspeed'     : 2,
                   'maxspeed'     : 8,
                  ...
                  {'numpoints'    : 4,
                   ...
                   'changecolor'  : True,
                   'keeplines'    : False}]
        main(resolution=(640,480), pointgroups=groups, fullscreen=True, screensaver=True)
